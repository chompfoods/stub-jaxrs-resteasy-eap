...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2021-03-09T22:27:28.365Z[GMT]")public class RecipeObjectItems   {
  ...
  private List<RecipeObjectIngredients> ingredients = new ArrayList<RecipeObjectIngredients>();
  private List<String> baseIngredients = new ArrayList<String>();
  private RecipeObjectNutrients nutrients = null;
  private List<String> diabeticExchanges = new ArrayList<String>();
