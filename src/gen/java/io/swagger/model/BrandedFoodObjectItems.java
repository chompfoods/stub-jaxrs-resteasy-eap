...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2020-01-22T13:41:42.086Z[GMT]")public class BrandedFoodObjectItems   {
  ...
  private List<BrandedFoodObjectComponents> components = new ArrayList<BrandedFoodObjectComponents>();
  private List<BrandedFoodObjectPortions> portions = new ArrayList<BrandedFoodObjectPortions>();
  ...
  private List<String> palmOilIngredients = new ArrayList<String>();
