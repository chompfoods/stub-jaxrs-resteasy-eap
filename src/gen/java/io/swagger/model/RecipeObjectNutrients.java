...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2021-03-09T22:27:28.365Z[GMT]")public class RecipeObjectNutrients   {
  private List<RecipeObjectNutrientsCalories> calories = new ArrayList<RecipeObjectNutrientsCalories>();
  private List<RecipeObjectNutrientsCalories> dailyValues = new ArrayList<RecipeObjectNutrientsCalories>();
  private List<RecipeObjectNutrientsCalories> fat = new ArrayList<RecipeObjectNutrientsCalories>();
  private List<RecipeObjectNutrientsCalories> carbs = new ArrayList<RecipeObjectNutrientsCalories>();
  private List<RecipeObjectNutrientsCalories> vitamins = new ArrayList<RecipeObjectNutrientsCalories>();
