...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2020-01-18T16:47:51.648Z[GMT]")public interface IngredientApi  {
    ...
    Response ingredientSearchPhpGet( @NotNull @QueryParam("find") Integer find, @NotNull @QueryParam("list") Boolean list, @QueryParam("raw") Boolean raw, @QueryParam("limit") Integer limit,@Context SecurityContext securityContext);
